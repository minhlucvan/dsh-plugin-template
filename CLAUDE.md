...
Repository contract for Claude-based sessions in `@your-scope/dsh-plugin-template`,
a standalone ESM Cordis plugin repository for DeepSeek Harness (DSH).

These rules mirror `AGENT.md`; `AGENTS.md` is the short contributor summary. Keep
all three consistent when the contract changes.
